	     ...
	     "oLanguage": {
    		...
    		"fnFooterCallback": function ( nRow, aaData, iStart, iEnd, aiDisplay ) {
                 ...
                 var nCells = secondRow.getElementsByTagName('th');
                    ...
                    nCells[5].innerHTML=iPage[1].toFixed(2);
                    nCells[6].innerHTML=iPage[2].toFixed(2);
                    nCells[7].innerHTML=iPage[3].toFixed(2);                       
                    
                    var thirdRow = $(secondRow).next()[0];
                    var nsCells = thirdRow.getElementsByTagName('th');
                    nsCells[4].innerHTML = iAverage[0].toFixed(2);
                    nsCells[5].innerHTML = iAverage[1].toFixed(2);
                    nsCells[6].innerHTML = iAverage[2].toFixed(2);
                    nsCells[7].innerHTML = iAverage[3].toFixed(2);
    		} 
	}
	).columnFilter();
} );
...
select nazwa, odczytid, odczytdata, okresod, okresdo, 
cieplogj, cieplopln,
