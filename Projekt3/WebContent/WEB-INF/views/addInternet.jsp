...
select nazwa, obiektid from obiekt
	...
	<h2 align="center">Dodaj wydatek na internet</h2>
	<form method="POST" commandName="addInternet"
		action="/Projekt3/saveInternet.html" id="formularz" name="form">
		<table align="center">
			<tr>
				<td align="left">Nazwa obiektu:</td>
				<td align="left"><select name="obiektNazwa" id="obiektNazwa" style="width: 200px; font-size: 18px">
			...
			<tr>
				...
				<td style="display: none;"><input name="obiektId" id="srt1"
					value="${internet.obiektId}"></td>
			</tr>
			<tr>
				<td>Data wystawienia:</td>
				<td><input name="internetDataWystawienia" id="datepicker"
					value="${internet.internetDataWystawienia}" class="required"></td>
			<tr>
				<td>Okres od:</td>
				<td><input name="internetOkresPoczatek" id="from"
					value="${internet.internetOkresPoczatek}" class="required"></td>
			</tr>
			<tr>
				<td>Okres do:</td>
				<td><input name="internetOkresKoniec" id="to"
					value="${internet.internetOkresKoniec}" class="required"></td>
			</tr>
			<tr>
				<td align="left">Kwota:</td>
				<td align="left"><input name="internetPLN"
					value="${internet.internetPLN}" class="required number"></td>
			<tr />
		</table>
		<center>
	...
	<sql:query var="internet" dataSource="${postgres}">
select nazwa, internetid, internetdata, okresod, okresdo, kwotainternet, obiektid
from obiekt
inner join internet using (obiektid)
	...
	<div style="width: 90%; margin-left: 5%">
		<table align="left" border="1" id="myTable" cellspacing="0px"
			...
			<tbody>
				<c:forEach var="row" items="${internet.rows}">
					<tr>
						<td align="center" style="display: none;"><c:out
								value="${row.internetid}" /></td>
						<td align="center"><c:out value="${row.internetdata}" /></td>
						<td align="center"><c:out value="${row.okresod}" /></td>
						<td align="center"><c:out value="${row.okresdo}" /></td>
						<td align="center"><c:out value="${row.kwotainternet}" /></td>
						<td align="center"><c:out value="${row.nazwa}" /></td>
						<td align="center"><a
							href="deleteInternet.html?id=${row.internetid}"
